    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7 py-3">
                ...
                <form role="form" action="{{ url('create-stripe-subscription') }}" method="post" class="require-validation" data-cc-on-file="false"
                    ...
                    <div class="form-div">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <x-jet-input type="text" name="fname" placeholder="First Name" class="form-control fname name-form" value="Muhammad" autofocus autocomplete="name"/>
                                @error('fname')
                                <span class="text-danger"> {{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                <x-jet-input type="text" id="lname" name="lname" placeholder="Last Name" class="marginTop form-control lname name-form" value="Ahtisham" autofocus autocomplete="last_name"/>
                                @error('lname')
                                <span class="text-danger"> {{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <x-jet-input type="text" id="address" name="address" placeholder="Street Address" class="form-control name-form" value="North Nazimabad" autofocus autocomplete="address"/>
                                @error('address')
                                <span class="text-danger"> {{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6">
                                <x-jet-input type="text" id="city" name="city" placeholder="City" class="marginTop form-control lname name-form" value="Karachi" autofocus autocomplete="city" />
                                @error('city')
                                <span class="text-danger"> {{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="row mt-3">
                            <div class="col-md-4">
                                <x-jet-input type="number" id="postal" name="postal" placeholder="Postcode / Zip" class="form-control name-form" value="1234567" autofocus autocomplete="postal" />
                                @error('postal')
                                <span class="text-danger"> {{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="col-md-4">
                                <x-jet-input type="text" id="state" name="state" placeholder="State" class="marginTop form-control name-form" value="Sindh" autofocus autocomplete="state" />
                                @error('state')
                                <span class="text-danger"> {{ $message }}</span>
                                @enderror
                            </div>
                        ...
                        <div class="form-group mt-3">
                            <x-jet-input type="number" id="contact" name="contact" placeholder="Phone Number" class="form-control name-form" value="09383737373" autofocus autocomplete="contact"  />
                            @error('contact')
                            <span class="text-danger"> {{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <x-jet-input type="password" id="password" name="password" placeholder="Password" value="12345678" class="form-control name-form" autocomplete="new-password" />
                            @error('password')
                            <span class="text-danger"> {{ $message }}</span>
                            @enderror
                        </div>
                        ...
                        <div class="form-group">
                            <x-jet-input type="password" id="password_confirmation" name="password_confirmation" value="12345678" placeholder="Confirm Password" class="form-control name-form" autocomplete="new-password" />
                            ...
                            <div class="container py-3">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        ...
                                        <input type="text" id="owner" name="owner"  placeholder="Owner Name" class="form-control card-num name-form card-holder" value="{{ old('owner') }}">
                                        @error('owner')
                                        <span class="text-danger"> {{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="col-md-12 mt-3">
                                        ...
                                        <input type="number" id="cardNumber" name="cardNumber" placeholder="1234 1234 1234 1234" class="form-control card-num name-form card-number" value="4242424242424242">
                                        @error('cardNumber')
                                        <span class="text-danger"> {{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="col-md-12 py-3">
                                        ...
                                        <input type="hidden" id="amount" name="amount" class="form-control fname card-exp name-form amount" value="{{ $amount }}"  readonly>
                                        ...
                                        <input type="hidden" id="stripePlan" name="stripePlan" class="form-control fname card-exp name-form" value="{{ $stripePlan }}"  readonly>
                                        @error('cvv')
                                        <span class="text-danger"> {{ $message }}</span>
                                        @enderror
                                    </div>
                                    <div class="form-group col-md-6" id="expiration-date">
                                        ...
                                        <select class="form-control card-expiry-month" id="expiration-month" name="expiration-month" style="float: left; width: 100px; margin-right: 10px;">
                                            @foreach($months as $k=>$v)
                                                <option value="{{ $k }}" {{ old('expiration-month') == $k ? 'selected' : '' }}>{{ $v }}</option>
                                            @endforeach
                                        </select>
                                        <select class="form-control card-expiry-year" id="expiration-year" name="expiration-year"  style="float: left; width: 100px;">
                    ...
                    <br>
                    <button class="btn btn-primary btn-lg btn-block" type="submit">Subscribe Now</button>
