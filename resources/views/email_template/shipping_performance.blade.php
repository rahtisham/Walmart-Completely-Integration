...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-8">
                                        ...
                                        <table width="600" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td class="res-center" style="text-align: center; color: white; font-family: 'Raleway', Arial, Sans-serif; font-size: 36px; letter-spacing: 1.5px; word-break: break-word; font-weight: 800; padding-left: 1.5px;" data-color="M1 Title 1" data-size="M1 Title 1" data-max="36" data-min="16">
                                                    SHIPPING PERFORMANCE FROM APPEALLAB
                                                </td>
                                            </tr>
                                            <!-- title end -->
                                            <tr>
            ...
            @foreach($shippingStatus as $shipping)
                <!-- ====== Module : Texts ====== -->
                                        ...
                                        <td><br><br>
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    ...
                                                    <td style="text-align: left">
                                                        {{ $shipping['TotalOrders'] }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="col">Get Orders</th>
                                                    <td style="text-align: left">
                                                        {{ $shipping['OrdersShipment'] }}
                                                    </td>
                                                </tr>
                                                <tr>
                ...
                <h1 style="text-align: center;">Delivery Performance</h1>
                ...
                <h1 style="text-align: center;">Regional Performance</h1>

                @foreach($regionalCity as $regional)
                <!-- ====== Module : Texts ====== -->
                    <table bgcolor="#F5F5F5" align="center" class="full selected-table" border="0" cellpadding="0" cellspacing="0" data-thumbnail="http://www.stampready.net/dashboard/editor/user_uploads/zip_uploads/2020/03/22/9jhlVUzudcB8NtbnMg67SvA5/StampReady/thumbnails/thumb-2.png" data-module="Module-2" data-bgcolor="M2 Bgcolor 1">
                        <tbody>
                        <tr>
                ...
                <h1 style="text-align: center;">Carrier Performance</h1>

                @foreach($carrierStatus as $carrier)
                <!-- ====== Module : Texts ====== -->
                    <table bgcolor="#F5F5F5" align="center" class="full selected-table" border="0" cellpadding="0" cellspacing="0" data-thumbnail="http://www.stampready.net/dashboard/editor/user_uploads/zip_uploads/2020/03/22/9jhlVUzudcB8NtbnMg67SvA5/StampReady/thumbnails/thumb-2.png" data-module="Module-2" data-bgcolor="M2 Bgcolor 1">
                        <tbody>
                        <tr>
                                    ...
                                    <tr>
                                        <td><br><br>
                                            <table class="table table-bordered">
                                                ...
                                                <tr>
                                                    <th scope="col">Number of Carriers</th>
                                                    <td style="text-align: left">
                                                        {{ $carrier['NoOfCarrier'] }}
                                                    </td>
                                                </tr>
