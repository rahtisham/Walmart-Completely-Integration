                                        ...
                                        <table width="600" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td class="res-center" style="text-align: center; color: white; font-family: 'Raleway', Arial, Sans-serif; font-size: 36px; letter-spacing: 1.5px; word-break: break-word; font-weight: 800; padding-left: 1.5px;" data-color="M1 Title 1" data-size="M1 Title 1" data-max="36" data-min="16">
                                                    SHIPPING PERFORMANCE ITEMS FROM APPEALLAB
                                                </td>
                                            </tr>
                                            <!-- title end -->
                                            <tr>
                                    ...
                                    <tr>
                                        <td><br><br>
                                            <table class="table table-bordered">
                                                <thead>
                                                <tr>
                                                    <th scope="col">IP CLAIM</th>
                                                    <td style="text-align: left">
                                                        {{ $shippingPerformance['ip_claim'] ? $shippingPerformance['ip_claim'] : 'No Ip Claim mentioned by Walmart'}} }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="col">OFFENSIVE PRODUCT</th>
                                                    <td style="text-align: left">
                                                        {{ $shippingPerformance['offensive_product'] ? $shippingPerformance['offensive_product'] : 'No Offensive Product mentioned by Walmart'}} }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="col">REGULATORY COMPLIANCE</th>
                                                    <td style="text-align: left">
                                                        {{ $shippingPerformance['regulatory_compliance'] ? $shippingPerformance['regulatory_compliance'] : 'No Regulatory Compliance mentioned by Walmart'}} }}
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <th scope="col">BRAND PARTNERSHIP VIOLATION</th>
                                                    <td style="text-align: left">
                                                        {{ $shippingPerformance['brand_partnership_violation'] ? $shippingPerformance['brand_partnership_violation'] : 'No Brand Partnership Violiation mentioned by Walmart'}}
                                                    </td>
                                                </tr>
                                                </thead>
                                            </table>
