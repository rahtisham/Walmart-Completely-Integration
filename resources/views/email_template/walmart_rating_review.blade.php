    ...
    <div class="row">
        ...
        <div class="col-sm-8">
            <div data-template-type="html" style="height: auto; padding-bottom: 149px;" class="ui-sortable">
                                        ...
                                        <table width="600" align="center" class="margin-pad" border="0" cellpadding="0" cellspacing="0">
                                            ...
                                            <tr>
                                                <td class="res-center" style="text-align: center; color: white; font-family: 'Raleway', Arial, Sans-serif; font-size: 36px; letter-spacing: 1.5px; word-break: break-word; font-weight: 800; padding-left: 1.5px;" data-color="M1 Title 1" data-size="M1 Title 1" data-max="36" data-min="16">
                                                    RATING AND REVIEW FROM APPEALLAB
                                                </td>
                                            </tr>
                                            <!-- title end -->
                                            <tr>
                ...
                @foreach($mailSenderArray as $check)
                <!-- ====== Module : Texts ====== -->
                                ...
                                <tr>
                                    <td><br><br>
                                        <table class="table table-bordered">
                                            ...
                                            <tr>
                                                <th scope="col">Offer Score</th>
                                                <td style="text-align: left">
                                                    {{ $check['offerScore'] }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th scope="col">Rating Review Score</th>
                                                <td style="text-align: left">
                                                    {{ $check['ratingReviewScore'] }}
                                                </td>
                                            </tr>
                                            <tr>
                                            ...
                                            <tr>
                                                <th scope="col">Item DefectCnt</th>
                                                <td style="text-align: left">
                                                    {{ $check['itemDefectCnt'] }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th scope="col">Defect Ratio</th>
                                                <td style="text-align: left">
                                                    {{ $check['defectRatio'] }}
                                                </td>
                                            </tr>
                                            <tr>
                                                <th scope="col">Listing Quality</th>
                                                <td style="text-align: left">
                                                    {{ $check['listingQuality'] }}
                                                </td>
                                            </tr>
                                            <tr>
