                ...
                <form method="POST" action="{{ route('register') }}">
                    ...
                    <div class="form-div">
                        ...
                        <div class="form-group mt-3">
                            <x-jet-input type="number" id="contact" name="contact" placeholder="Phone (Optional)" class="form-control name-form" value="{{ old('contact') }}" autofocus autocomplete="contact"  />
                            @error('contact')
                            <span class="text-danger"> {{ $message }}</span>
                            @enderror
                        </div>
