                    ...
                    <div class="profile-head">
                        ...
                        <div class="profile-info">
                            <div class="profile-photo">
                                <img src="http://127.0.0.1:8000/AppealLab/images/profile/user.png" class="img-fluid rounded-circle" alt="">
                            </div>
                            <div class="profile-details">
                                ...
                                <div class="profile-email px-2 pt-2">
                                    <h4 class="text-muted mb-0">{{ $user->name }} {{ $user->last_name }}</h4>
                                    <p>{{ $user->email }}</p>
                                </div>
                    ...
                    <div class="card-body">
                        <div class="media align-items-center">
                            ...
                            <div class="media-body">
                                <p class="fs-14 mb-2">Rating & Review</p>
                                <span class="title text-black font-w600">33</span>
                            </div>
                        </div>
                ...
                <div class="card avtivity-card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            ...
                            <div class="media-body">
                                <p class="fs-14 mb-2">Regulatory Compliance</p>
                                <span class="title text-black font-w600">33</span>
                            </div>
                        </div>
                        <div class="progress" style="height:5px;">
                ...
                <div class="card avtivity-card">
                    <div class="card-body">
                        <div class="media align-items-center">
                            ...
                            <div class="media-body">
                                <p class="fs-14 mb-2">Carrier Performance</p>
                                <span class="title text-black font-w600">33</span>
                            </div>
                        </div>
                        <div class="progress" style="height:5px;">
                                        ...
                                        <div class="card avtivity-card">
                                            <div class="card-body">
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <p class="fs-14 mb-2">IP CLAIM</p>
                                                        <span class="title text-black font-w600">67</span>
                                                    </div>
                                                </div>
                                                <div class="progress" style="height:5px;">
                                        ...
                                        <div class="card avtivity-card">
                                            <div class="card-body">
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <p class="fs-14 mb-2">Regional Performance</p>
                                                        <span class="title text-black font-w600">56</span>
                                                    </div>
                                                </div>
                                                <div class="progress" style="height:5px;">
                                                    <div class="progress-bar bg-secondary" style="width: 82%; height:5px;" role="progressbar">
                                        ...
                                        <div class="card avtivity-card">
                                            <div class="card-body">
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <p class="fs-14 mb-2">On Time Shipment</p>
                                                        <span class="title text-black font-w600">77</span>
                                                    </div>
                                                </div>
                                                <div class="progress" style="height:5px;">
                                        ...
                                        <div class="card avtivity-card">
                                            <div class="card-body">
                                                <div class="media align-items-center">
                                                    ...
                                                    <div class="media-body">
                                                        <p class="fs-14 mb-2">On Time Delivery</p>
                                                        <span class="title text-black font-w600">33</span>
                                                    </div>
                                                </div>
                                                <div class="progress" style="height:5px;">
                        ...
                        <div class="profile-tab">
                            <div class="custom-tab-1">
                                <ul class="nav nav-tabs">
                                    <li class="nav-item"><a href="#my-posts" data-toggle="tab" class="nav-link">Subscription</a>
                                    </li>
                                    <li class="nav-item"><a href="#about-me" data-toggle="tab" class="nav-link">Marketplace</a>
                                    </li>
                                    <li class="nav-item"><a href="#profile-settings" data-toggle="tab" class="nav-link active show">Personal Information</a>
                                    </li>
                                </ul>
                                <div class="tab-content">
                                                ...
                                                <table id="example" class="display min-w850">
                                                    ...
                                                    <tbody>
                                                        @if (count($paymentLogs) > 0)
                                                            ...
                                                            <tr>
                                                                <td>{{ $paymentLog['subscriptionName'] }}</td>
                                                                <td>{{ $paymentLog['amount'] }}</td>
                                                                <td>{{ $paymentLog['name_on_card'] }}</td>
                                    ...
                                    <div id="about-me" class="tab-pane fade">
                                        <div class="profile-about-me"><br>
                                            <div class="pt-4 border-bottom-1 pb-3">
                                                <h4 class="text-primary">User Marketplace Credential</h4>
                                             </div>
                                        </div>
                                        <div class="profile-personal-info">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-sm-3 col-5">
                                                    <h5 class="f-w-500">Client Id<span class="pull-right">:</span>
                                                    </h5>
                                                </div>
                                                <div class="col-sm-9 col-7">
                                                    @if ($marketplace)
                                                    <span>{{ $marketplace->client_id }}</span>
                                                    @else
                                                    Not found
                                                    @endif
                                                </div>
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-sm-3 col-5">
                                                    <h5 class="f-w-500">Client Secret <span class="pull-right">:</span></h5>
                                                </div>
                                                <div class="col-sm-9 col-7">
                                                    @if ($marketplace)
                                                    <span>{{ $marketplace->client_secret }}</span>
                                                    @else
                                                    Not found
                                                    @endif
                                                </div>
                                    ...
                                    <div id="profile-settings" class="tab-pane fade active show">
                                        ...
                                        <div class="profile-personal-info">
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-sm-9 col-7"><span>{{ $user->contact }}</span>
                                                </div>
                                            </div>
                                            <div class="row mb-2">
                                                <div class="col-sm-3 col-5">
                                            ...
                                            <div class="row mb-2">
                                                <div class="col-sm-3 col-5">
                                                    <h5 class="f-w-500">Postal Code <span class="pull-right">:</span></h5>
                                                </div>
                                                <div class="col-sm-9 col-7"><span>{{ $user->postal }}</span>
                                                </div>
                                            </div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-sm-9 col-7"><span>Active</span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
