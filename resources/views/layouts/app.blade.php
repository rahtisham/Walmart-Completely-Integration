...
{{--            <img class="logo-compact" src="{{ asset('AppealLab/images/logo-text.png') }}" alt="">--}}
        ...
        <div class="nav-control">
            <div class="hamburger">
                <span style="color: red;" class="line"></span><span class="line"></span><span class="line"></span>
            </div>
        </div>
    </div>
    <!--**********************************
...
{{--                        <li><a href="{{ route('dashboard.client') }}">Client</a></li>--}}
{{--                        <li><a href="{{ route('dashboard.shipping-performance') }}">Shipping Performance</a></li>--}}
{{--                        <li><a href="{{ route('dashboard.rating-review') }}">Rating & Raview</a></li>--}}
{{--                        <li><a href="{{ route('dashboard.on-time-shipment') }}">On Time Shipping</a></li>--}}
{{--                        <li><a href="{{ route('dashboard.on-time-delivery') }}">On Time Delivery</a></li>--}}
{{--                        <li><a href="{{ route('dashboard.carrier-performance') }}">Carrier Performance</a></li>--}}
{{--                        <li><a href="{{ route('dashboard.regional-performance') }}">Regional Performance</a></li>--}}
{{--                        <li><a href="{{ route('dashboard.order') }}">Orders</a></li>--}}
{{--                        <li><a href="{{ route('dashboard.order-status') }}">Orders Status Check</a></li>--}}
{{--                        <li><a href="{{ route('dashboard.items') }}">Walmart Items</a></li>--}}
{{--                    </ul>--}}
{{--                </li>--}}
{{--                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">--}}
{{--                        <i class="flaticon-381-television"></i>--}}
{{--                        <span class="nav-text">Authorize</span>--}}
{{--                    </a>--}}
{{--                    <ul aria-expanded="false">--}}
{{--                        <li><a href="{{ route('dashboard.authorize') }}">Integration</a></li>--}}
{{--                    </ul>--}}
{{--                </li>--}}
{{--                <li><a class="has-arrow ai-icon" href="javascript:void()" aria-expanded="false">--}}
...
{{--                    </li>--}}
{{--                    <li>--}}
{{--                        <a href="{{ url('dashboard/admin/user-view') }}">--}}
{{--                            <i class="flaticon-381-controls-3"></i>--}}
